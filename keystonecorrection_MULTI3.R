...
xu=c(405, 309, 761, 706)  # top-left, bottom-left, bottom-right, top-right
yu=c(145, 604, 615, 183)
...
width=height*22/31  # pixel art aspect ratio 31:22
side=mean(sides)
posx=(xu[1]+xu[2])/2
posy=(yu[1]+yu[2])/2
xd=c(posx, posx, posx+width, posx+width)
yd=c(posy-height/2, posy+height/2, posy+height/2, posy-height/2)
